    ...
    <>
        ...
        {os && (
          <div>
            ...
            >
            <Link className={buttonStyles({ color: "warning", radius: "lg", variant: "shadow" })}>
            {getsvgBasedOnOS()}
                Downoad For {os.toString()}
                </Link>
          </a>
          </div>
        )}
